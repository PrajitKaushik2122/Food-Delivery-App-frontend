                ...
                <div className="col-lg-8">
                        ...
                        <div className="card-body">
                            <div className="row cart-item mb-3">
                                <div className="col-md-3">
                                    <img alt="Product 1" className="img-fluid rounded" />
                                </div>
                                ...
                                <div className="col-md-2">
                                    <div className="input-group">
                                        ...
                                        <input style={{"max-width":"100px"}} type="text" className="form-control  form-control-sm text-center quantity-input" value="1" />
                                        <button className="btn btn-outline-secondary btn-sm" type="button">+</button>
                                    </div>
                                </div>
                            ...
                            <hr/>
                                <div className="row cart-item">
                                    <div className="col-md-3">
                                        <img alt="Product 2" className="img-fluid rounded" />
                                    </div>
                                    <div className="col-md-5">
                                    ...
                                    <div className="col-md-2">
                                        <div className="input-group">
                                            <button className="btn btn-outline-secondary btn-sm" type="button">-</button>
                                            <input style={{"max-width":"100px"}} type="text" className="form-control form-control-sm text-center quantity-input" value="2" />
                                            <button className="btn btn-outline-secondary btn-sm" type="button">+</button>
                                        </div>
                                    </div>
                                    <div className="col-md-2 text-end">
                    ...
                    <div className="text-start mb-4">
                        <Link to="/" className="btn btn-outline-danger">
                            <i className="bi bi-arrow-left me-2"></i>Add More
                        </Link>
                    </div>
                </div>
